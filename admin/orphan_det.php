...
<body>
	...
	<tbody>
	<?PHP	
					  $sqlabout=mysql_query("select s_id,name,isapproved from inmates_details" ); 
					...
					while($resultabout=mysql_fetch_array($sqlabout))
					{
					 ?>
                      <tr bgcolor="#E1E1E1">
						...
						<a class="btn btn-info" href="orphan_det.php?mode=edit&amp;id=<?php echo $resultabout['s_id']; ?>">View
						<i class="halflings-icon white edit"></i>  
									</a>
									<?php
									if($resultabout['isapproved']==0)
									{
										?>
									
									<a class="btn btn-info" href="orphan_det.php?mode=app&amp;id=<?php echo $resultabout['s_id']; ?>">Approve
						<i class="halflings-icon white edit"></i>  
									</a>
									<?php } ?>	</td>
		...
		<?php
				...
				<div class="box-content">
				  ...
				  <div class="control-group">
					...
					<div class="controls"><input name="address" readonly="ture" type="text" class="button" size="60" value="<?PHP echo $about_data['age']; ?>" />
					</div>
					</div>
					<div class="control-group">
					<label class="control-label" for="typeahead">Gender </label>
					<div class="controls"><input name="address" readonly="ture" type="text" class="button" size="60" value="<?PHP echo $about_data['gender']; ?>" />
					</div>
					</div>
					
					<div class="control-group">
					<label class="control-label" for="typeahead">Schooling type </label>
					<div class="controls"><input name="email" readonly="ture" type="text" class="button" size="60" value="<?PHP echo $about_data['stud_type']; ?>" />
					</div>
					</div>
					<div class="control-group">
					<label class="control-label" for="typeahead">Grade </label>
					<div class="controls"><input name="phone" readonly="ture" type="text" class="button" size="60" value="<?PHP echo $about_data['grade']; ?>" />
					</div>
					</div>
					<div class="control-group">
					<label class="control-label" for="typeahead">Institution </label>
					<div class="controls"><input name="totalexp" readonly="ture" type="text" class="button" size="60" value="<?PHP echo $about_data['institution']; ?>" />
					</div>
					</div>
			  ...
			  <?PHP	
				...
				{
					$sql=mysql_query("update inmates_details set isapproved=1 where s_id=".$_GET['id']);
					header("Location: orphan_det.php?mode=show");
				}
				?>
