...
<tr style="margin-top:15px;">
  <td class="tex_td">Organisation Name        </td><td><input class="text_box2" id="nm" type="text" readonly value="<?php echo $detail['name'] ?>" />
</td>
</tr>
<tr>
   <td class="tex_td">Address                                           </td><td><input name="address" class="text_box2" type="text" readonly value="<?php echo $detail['address'] ?>"/></td>
</tr>
<tr><td class="tex_td">City                                              </td><td><input name="city" class="text_box2" type="text" readonly value="<?php echo $detail['city'] ?>" /></td>
</tr>

<tr>
<td class="tex_td">Phone                                              </td> <td><input name="Phone" class="text_box2" id="contno" type="text" readonly value="<?php echo $detail['phone'] ?>" /></td>
</tr> 
<td class="tex_td">Number of boy inmates                                               </td> <td><input name="Phone" class="text_box2" id="contno" type="text" readonly value="<?php echo $detail['mc'] ?>" /></td>
</tr> 
<td class="tex_td">Number of girl inmates                                              </td> <td><input name="Phone" class="text_box2" id="contno" type="text" readonly value="<?php echo $detail['fc'] ?>" /></td>
</tr> 
<td class="tex_td">Total number of inmates                                              </td> <td><input name="Phone" class="text_box2" id="contno" type="text" readonly value="<?php echo $detail['tc'] ?>" /></td>
</tr> 
</tr> 
<td class="tex_td">Age group                                              </td> <td><input name="Phone" class="text_box2" id="contno" type="text" readonly value="<?php echo $detail['minage']." - ".$detail['maxage']; ?>" /></td>
</tr> 
<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
<tr><td class="tex_td" colspan="2"><center>
<a name="back" href="orphanages.php?mode=show_orphanages" value="Back" class="myButton">Back</a></center></td>
</tr>
</table>
<br />
